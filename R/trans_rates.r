#' trans_rates
#'
#' @description Calculate the daily transition rates for Aedes in function the two stages considered.
#' Daily rate (day^-1)  consists in a number in a day.  It is based on Poletti et al work (2011) and Magori et al work.
#' 
...
#' @param transition   character Name of transition :  "Ovidepostion" - "Eggs2larvae" - "Larvae2Pupae" - "Pupae2Adult". Default is "Ovidepostion".
#' @return trans_rates
...
#' @author  Istituto di Biometeorologia Firenze Italy  Alfonso crisci \email{a.crisci@@ibimet.cnr.it} ASL LUCCA Marco Selmi \email{marco.selmi@@uslnordovest.toscana.it }#' @keywords  Container
#'
#'
#' 
#' 
